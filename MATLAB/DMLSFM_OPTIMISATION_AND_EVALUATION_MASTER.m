%EXP_13_1_21_DMLSFM_OPTIMISATION_AND_EVALUATION_MASTER
%optimised master - removed background and scores
clear;
clf;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%load libraries
...
if ~mem_map.bEvaluate
    Speak('Optimisation Program');
else
    Speak('Evaluation Program');
end
