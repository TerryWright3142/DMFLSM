%EXP_13_1_21_DMLSFM_OPTIMISATION_AND_EVALUATION_SLAVE
%
%
...
disp('1. capture optimisation images');
tic();
...
disp('1. end');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('2. analyse optimisation images');
tic();
...
disp('2. end');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('3 capture optimisal images');
tic();
