%EXP_13_1_21_DMLSFM_HCI_STROBE_MASTER
%%%%%%% this is to be used with  EXP_13_1_21_DMLSFM_HCI_STROBE.vi
%
...
%this program allows you to clearly see that the refocussing is working OK
%at the desired rate of volumetric imaging
clear;
clf;
%load libraries
addpath('..\');
